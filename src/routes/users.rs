...
#[get("/users")]
pub fn get_users(connection: Conn, _guard : JwtGuard) -> ApiResponse {
...
pub fn create_user(connection: Conn, user: Json<InsertableUser>) -> ApiResponse {
    let user_coll = &connection.collection(COLLECTION);
...
#[get("/users/<id>")]
pub fn get_users_by_id(connection: Conn, id: Uuid, _guard : JwtGuard) -> ApiResponse {
    let user_coll = &connection.collection(COLLECTION);
    let id =  id.to_string();
...
pub fn update_user(connection: Conn, user: Json<InsertableUser>, id: Uuid, _guard : JwtGuard) -> ApiResponse {
    let user_coll = &connection.collection(COLLECTION);
    let id =  id.to_string();
    match user_coll.find_one(Some(doc! { "_id": id.clone() }), None) {
        Ok(find_one) => {
...
pub fn delete_user(connection: Conn, user: Json<UserPassword>, id: Uuid, _guard : JwtGuard) -> ApiResponse {
    let user_coll = &connection.collection(COLLECTION);
    let id =  id.to_string();
    match user_coll.find_one(Some(doc! { "_id": id.clone() }), None) {
        Ok(find_one) => {
...
pub fn get_users_by_email(connection: Conn, email: String, _guard : JwtGuard) -> ApiResponse {
    let user_coll = &connection.collection(COLLECTION);
